...
class Permission extends Base
{
     ...
     */
    static function create(mixed ...$args): static
    {
        return static::createFromHex(...$args);
    }
     ...
     * @return [type]        [description]
     */
    static function createFromHex(mixed $perm = 0): static
    {
     ...
     * @return [type]        [description]
     */
    static function createFromDec(mixed $perm = 0): static
    {
     ...
     * @return [type]        [description]
     */
    static function createFromBin(mixed $perm = 0): static
    {
     ...
     */
    function __construct(mixed $perm = 0, string $format = 'hex')
    {
     ...
     * @param string $format [description]
     */
    function setPermission(mixed $perm = null, string $format = 'hex'): static
    {
        ...
        if ($format == 'acronym')
        {
            if (is_string($perm))
            {
                ...
                $acceptableAcronym = ['s' => 'select', 'i' => 'insert', 'u' => 'update', 'd' => 'delete'];
                $perm = ['select' => false, 'insert' => false, 'update' => false, 'delete' => false];
     ...
     * @param [type] $perm [description]
     */
    function setSelectPermission(mixed $perm = null): static
    {
     ...
     * @param [type] $perm [description]
     */
    function setInsertPermission(mixed $perm = null): static
    {
     ...
     * @param [type] $perm [description]
     */
    function setUpdatePermission(mixed $perm = null): static
    {
     ...
     * @param [type] $perm [description]
     */
    function setDeletePermission(mixed $perm = null): static
    {
     ...
     * @return [type] [description]
     */
    function getPermission(mixed ...$args): mixed
    {
        $permission = [
        ...
        {
            $perm = $args[1] ?? null;
            if ($perm !== null && array_key_exists($perm, $permission))
            {
     ...
     * @return [type] [description]
     */
    function getSelectPermission(): bool
    {
        return $this->select;
    }
     ...
     * @return [type] [description]
     */
    function getInsertPermission(): bool
    {
        return $this->insert;
    }
     ...
     * @return [type] [description]
     */
    function getUpdatePermission(): bool
    {
        return $this->update;
    }
     ...
     * @return [type] [description]
     */
    function getDeletePermission(): bool
    {
        return $this->delete;
    }
}
