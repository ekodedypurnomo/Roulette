...
/**
 * SubClass for Validator — date format validation. Not yet implemented.
 *
...
{
    protected mixed $rule = 'Y-m-d';
    protected ?string $message = 'value is not a valid date, expected format: {rule}';
