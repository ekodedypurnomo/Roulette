...
/**
 * SubClass for Validator — time format validation. Not yet implemented.
 *
...
{
    protected mixed $rule = 'H:i:s';
    protected ?string $message = 'value is not a valid time, expected format: {rule}';
